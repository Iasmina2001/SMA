...
public class PaymentAdapter extends ArrayAdapter<Payment> implements Serializable {

    private Context context;
    private List<Payment> payments;
    private int layoutResID;
    private Payment pItem;
    ...
    private void delete(String timestamp) {
        ...
        if (!AppState.isNetworkAvailable(context.getApplicationContext())) {
            AppState.get().updateLocalBackup(context.getApplicationContext(), pItem, false);
        }
    }
